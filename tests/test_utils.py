...
# TEST 4: informeButacasDisponibles
def test_informe_butacas_disponibles():
    ...
    # Marcar una como ocupada
    asientos["A1"]["ocupado"] = True
    disponibles = informeButacasDisponibles(asientos)
    assert "A1" not in disponibles

# TEST 5: butacasDisponiblesPorTipo
...
# TEST 6: Funciones de películas y cines (sin archivos)
